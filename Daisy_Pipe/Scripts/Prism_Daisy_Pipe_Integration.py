...
class Prism_Daisy_Pipe_Integration(object):
    def __init__(self, core, plugin):
        ...
        if platform.system() == "Windows":
            self.examplePath = (
                self.core.getWindowsDocumentsPath() + "\\Daisy_Pipe\\2019"
            )
            ...
            self.examplePath = os.path.join("/home", userName, "Daisy_Pipe", "2019")
            ...
            self.examplePath = (
                "/Users/%s/Library/Preferences/Autodesk/Daisy_Pipe/2019" % userName
            )
    ...
    def getExecutable(self):
        execPath = ""
        if platform.system() == "Windows":
            defaultpath = os.path.join(self.getDaisy_PipePath(), "Daisy_Pipe.exe")
    ...
    def addIntegration(self, installPath):
        try:
            ...
            msgStr = (
                "Errors occurred during the installation of the Daisy_Pipe integration.\nThe installation is possibly incomplete.\n\n%s\n%s\n%s"
    ...
    def removeIntegration(self, installPath):
        try:
            ...
            msgStr = (
                "Errors occurred during the removal of the Daisy_Pipe integration.\n\n%s\n%s\n%s"
                % (str(e), exc_type, exc_tb.tb_lineno)
            )
            msgStr += "\n\nRunning this application as administrator could solve this problem eventually."
