...
class Prism_SubstancePainter_unloaded(
    ...
    """SubstancePainter plugin in unloaded state.
    
    Represents the SubstancePainter plugin when Prism is not running inside SubstancePainter.
    Provides access to external functions, integration management, and
    configuration without requiring SubstancePainter to be running.
    ...
    def __init__(self, core):
        """Initialize unloaded SubstancePainter plugin.
